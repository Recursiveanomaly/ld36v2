...
public class CityPanel : MonoBehaviour 
{
    ...
    void Awake()
    {
        if (m_introPanel != null)
        {
            ...
            m_introPanel.transform.position = new Vector3(m_introPanel.transform.position.x, m_startingIntroY, m_introPanel.transform.position.z);
    ...
    public void Peek()
    {
        ...
        m_introPanel.transform.DOMoveY(m_startingIntroY - 850, 0.5f);
    }
    ...
    public void CloseIntro()
    {
        if (m_introPanel != null)
        {
            ...
            m_introPanel.transform.DOMoveY(m_startingIntroY - 850, 0.75f);
            m_isIntroOpen = false;
    ...
    public void ReOpenIntro()
    {
        if (m_introPanel != null)
        {
            ...
            m_introPanel.transform.DOMoveY(m_startingIntroY, 0.75f);
            m_isIntroOpen = true;
            if (m_introPanelBlocker != null) m_introPanelBlocker.gameObject.SetActive(true);
            //m_introPanel.gameObject.SetActive(true);
